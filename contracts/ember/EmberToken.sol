...
// File @openzeppelin/contracts/metatx/ERC2771Context.sol@v4.2.0
pragma solidity ^0.8.0;
...
// File contracts/ember/EmberToken.sol
...
contract EmberToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    uint256 private _maxSupply = 21000 * 10**4 * 10**decimals(); // 210,000,000(mln) tokens is maximum supply
    uint256 private _initialSupply = 21 * 10**4 * 10**decimals(); // 210,000(thousand) tokens is the initial supply
    ...
    constructor(address trustedForwarder) ERC20("Ember Token", "EMBER") ERC20Permit("Ember Token") {
